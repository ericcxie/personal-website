        ...
        <ul className="relative border-l -pl-0 border-gray-200 dark:border-gray-700 font-gilroy">
          <li className="mb-10 ml-4">
            ...
            <div data-aos="fade-up" data-aos-once data-aos-delay="400">
              ...
              <p className="mt-2 text-base font-normal text-gray-500 dark:text-gray-400 max-w-2xl">
                Worked as a software developer on the Transformation Team to
                help automate insurance bidding processes. Built financial tools
                to generate pricing models/memo reports.
              </p>
          ...
          <li className="mb-10 ml-4">
            ...
            <div data-aos="fade-up" data-aos-once data-aos-delay="100">
              ...
              <p className="mt-2 text-base font-normal text-gray-500 dark:text-gray-400 max-w-2xl">
                Conducted an independent research project on machine learning
                used in PD-1 related medicine using library databases to explore
