        ...
        <section className='py-10 mb-10'>
            ...
            <div class="mt-3 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div className="relative group">
                    ...
                    <a href="#" class="dark:bg-darkmode relative block overflow-hidden rounded-lg border border-gray-100 hover:border-b-0 dark:border-none p-8 hover:shadow-lg transition ease-in-out delay-100 hover:-translate-y-1 dark:text-white">
                ...
                <div className="relative group">
                    ...
                    <a href="#" class="relative dark:bg-darkmode block overflow-hidden rounded-lg border border-gray-100 hover:border-b-0 hover:shadow-lg dark:border-none p-8 transition ease-in-out delay-100 hover:-translate-y-1 dark:text-white">
                        <div className='flex gap-3'>
                        ...
                        <span class="absolute inset-x-0 bottom-0 h-2 bg-gradient-to-r from-theme to-purple-600"></span>
                        <div class="justify-between sm:flex">
                            <div>
                                <h3 class="text-xl font-bold text-gray-900 dark:text-white">
                                    Personal Website
