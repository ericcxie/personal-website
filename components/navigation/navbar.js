      ...
      <div className="relative container flex flex-wrap items-center justify-between mx-auto pb-2 ">
        ...
        <ul className="hidden font-medium pt-1 lg:flex flex-1 justify-start items-center pl-10 text-md lg:gap-5 xl:gap-12 dark:text-gray-200">
          <li
            data-aos="fade-down"
            data-aos-delay="400"
            className="hover:bg-clip-text hover:dark:text-transparent hover:dark:bg-gradient-to-r hover:dark:from-[#3a7bd5] hover:dark:to-[#2997c5] hover:text-theme group text-gray-700 dark:text-gray-200 transition duration-300 cursor-pointer"
          >
            <ScrollLink
              to="home"
              spy={true}
