...
export default function Projects() {
    ...
    return (
        <section id='projects' className='py-10 mb-10 transition-colors duration-300'>
            ...
            <div className="mt-3 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 ">
                <div data-aos="fade-up" data-aos-once data-aos-delay='200' className="relative group">
