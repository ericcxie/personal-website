        ...
        <section id='projects' className='py-10 mb-10'>
            ...
            <div class="mt-3 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div className="relative group">
                    ...
                    <a href="#" className="dark:bg-darkmode min-h-full relative block overflow-hidden rounded-lg border border-gray-100 hover:border-b-0 dark:border-none p-8 hover:shadow-lg transition ease-in-out delay-100 hover:-translate-y-1 dark:text-white">
                ...
                <div className="relative group">
                    ...
                    <a href="#" className="relative dark:bg-darkmode min-h-full block overflow-hidden rounded-lg border border-gray-100 hover:border-b-0 hover:shadow-lg dark:border-none p-8 transition ease-in-out delay-100 hover:-translate-y-1 dark:text-white">
                        <div className='flex gap-3'>
