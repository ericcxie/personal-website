        ...
        <section id='home' className='flex mb-64 md:mb-24 items-center md:justify-between py-24 md:px-90'>
            <div className='pb-28 md:pb-20'>
              <div className='pl-1'> {/* Home page */}
                <h2 data-aos='fade-up' data-aos-delay='1700' className='py-2 ml-1 font-mono font-thin text-light-font dark:text-gray-200 text-md lg:text-lg'>Hi, my name is</h2>
                <div className='flex gap-2 justify-start text-6xl xl:text-7xl'>
                  ...
                  <div data-aos='fade-up' data-aos-delay='2000' className='ml-1 font-poppins mt-3 md:mt-4 font-light text-gray-800 dark:text-gray-100 text-2xl md:text-3xl'>
                    <TypeAnimation
              ...
              <div data-aos='fade-up' data-aos-delay='2100' className='py-1 px-1 flex justify-start gap-4 mt-5'>
              ...
              <div data-aos='fade-up' data-aos-delay='2200' className='text-2xl flex justify-start gap-1 pl-1 py-2 md:text-3xl dark:text-white md:hidden lg:hidde'>
            ...
            <div data-aos='fade-up' data-aos-delay='2100' className='hidden md:w-1/2 md:inline'><Image src={dots}/></div>
          </section>
    );
}
