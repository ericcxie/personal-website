              ...
              <div className='py-2 px-1 flex justify-start gap-4'>
                <ScrollLink to="projects" spy={true} smooth={true} offset={-20} duration={700}>
                  <div className="relative group">
                    ...
                    <button className="relative font-poppins text-small bg-theme hover:bg-dark dark:bg-[#0d122b] text-white dark:text-gray-100 font-medium py-1.5 px-12 rounded-lg pt-2 pb-2">
                      Projects 
                    </button>
