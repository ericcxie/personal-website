    ...
    return (
        <section>
            <div className={darkMode ? "dark" : ""}>
                ...
                <Link href='/'>
                    <button className='px-4 py-2 text-2xl lg:text-2xl font-poppins font-bold text-theme cursor-pointer bg-clip-text dark:text-transparent dark:bg-gradient-to-r dark:from-[#3a7bd5] dark:to-[#2997c5]'>Eric Xie.</button>
                </Link>
                <div
                ...
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <h1 className="text-[#BDBDBD] dark:text-white text-3xl font-extrabold text-transparent md:text-5xl"> My Apple Gear</h1>
