            ...
            <div className='mt-3 flex flex-col justify-center items-start'>
                <ul data-aos='fade-up' data-aos-once className="relative border-l -pl-0 border-gray-200 dark:border-gray-700">                  
                    <li className="mb-10 ml-4">
                        ...
                        <p className="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">Designing and developing RPA softwares to automate business processes</p>
                    </li>
                    <li className="mb-10 ml-4">
                        <div className="absolute w-3 h-3 bg-theme rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"/>
                ...
                <div data-aos='fade-up' data-aos-once className="relative group mt-6 md:mt-10 transition-colors duration-300">
                    ...
                    <Link href="/resume.pdf">
                            ...
                            Receive CV <svg className="ml-2 w-3 h-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg></button>
                    </Link>
                </div>
